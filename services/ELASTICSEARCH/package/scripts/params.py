...
gateway_recover_after_nodes = config['configurations']['elastic-site']['gateway_recover_after_nodes']
node_max_local_storage_nodes = config['configurations']['elastic-site']['node_max_local_storage_nodes']

action_destructive_requires_name = str(config['configurations']['elastic-site']['action_destructive_requires_name'])